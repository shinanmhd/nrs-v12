(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~charts-chartslib-module~dashboards-dashboards-module"], {
    /***/
    "Cr32":
    /*!***********************************************************************!*\
    ...
    /***/
    function Cr32(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function renderChart() {
            ...
            return Promise.all(promises).then(function (values) {
              var _values = _toArray(values),
                  type = _values[0],
                  args = _values.slice(1);

              if (!(type in chartist__WEBPACK_IMPORTED_MODULE_0__)) {
                throw new Error("".concat(type, " is not a valid chart type"));
              }

              _this2.chart =
              /** @type {?} */
              chartist__WEBPACK_IMPORTED_MODULE_0__[type].apply(
              /** @type {?} */
              chartist__WEBPACK_IMPORTED_MODULE_0__, _toConsumableArray(args));
              return _this2.chart;
            });
          }
          /**
    ...
    /***/
    function LPYB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var BaseChartDirective = /*#__PURE__*/function () {
        ...
        _createClass(BaseChartDirective, [{
          ...
          value: function ngDoCheck() {
            ...
            */
            function (x, i) {
              return x.data !== _this4.old.datasetsDataObjects[i];
            }).length) {
            ...
            */
            function (x, i) {
              return x.data.length !== _this4.old.datasetsDataLengths[i];
            }).length) {
            ...
            */
            function (x, i) {
              return !_this4.colorsEqual(x, _this4.old.colors[i]);
            }).length) {
            ...
            */
            function (x, i) {
              return !_this4.labelsEqual(x, _this4.old.labels[i]);
            }).length) {
          ...
          value: function updateColors() {
            ...
            */
            function (elm, index) {
              if (_this5.colors && _this5.colors[index]) {
                Object.assign(elm, _this5.colors[index]);
              } else {
                Object.assign(elm, getColors(_this5.chartType, index, elm.data.length), Object.assign({}, elm));
              }
            });
          }
          /**
            ...
            function (key) {
              if (Array.isArray(overrides[key])) {
                ...
                if (arrayElements) {
                  ...
                  */
                  function (r) {
                    _this7.smartMerge(r, overrides[key][0], level + 1);
                  });
                }
                ...
                _this7.smartMerge(options[key], overrides[key], level + 1);
              } else {
              ...
              if (this.datasets && newDataValues.length === this.datasets.length) {
                ...
                */
                function (data, index) {
                  return {
                    data: data,
                    label: _this8.joinLabel(_this8.labels[index]) || "Label ".concat(index)
                  };
                });
...
//# sourceMappingURL=default~charts-chartslib-module~dashboards-dashboards-module-es5.js.map